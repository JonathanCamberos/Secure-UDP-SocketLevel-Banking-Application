...
def send_login_success_response(peer_sock, shared_key, 
                                iv, private_key, server_self_cert_bytes):

    header = Headers.LOGIN_SUCCESS_HEADER

    message = b"".join([header])

    BothMessages.encrypt_and_send(message, peer_sock, shared_key, 
                                  iv, private_key, server_self_cert_bytes)

    return

def send_login_error_response(peer_sock, shared_key, 
                              iv, private_key, server_self_cert_bytes):
...
def send_modify_savings_success_response(peer_sock, shared_key, 
                                         iv, private_key, server_self_cert_bytes):
...
def send_modify_savings_error_response(peer_sock, shared_key, 
                                       iv, private_key, server_self_cert_bytes):
...
def send_view_savings_success_response(savings, peer_sock, shared_key, 
                                       iv, private_key, server_self_cert_bytes):
...
def send_user_created_response(peer_sock, shared_key, 
                               iv, private_key, server_self_cert_bytes):
...
def send_user_mongo_error_response(peer_sock, shared_key, 
                                   iv, private_key, server_self_cert_bytes):
...
def send_user_name_taken_error_response(peer_sock, shared_key, 
                                        iv, private_key, server_self_cert_bytes):
...
def send_disconnect_succes_response(peer_sock, shared_key, 
                                    iv, private_key, server_self_cert_bytes):
